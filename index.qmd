...
##  Step one: 35 to 16 risk factors {background-image="lasso_full.png" background-size="contain"}
...
::: {.column width=50%"}
![](lasso_cv.png){style="width: 600px;height:500px; position: absolute; top: 50px; left: 550px"}
:::
:::
...
:::footer
[https://clinical-risk-calculators.sydney.edu.au/Nomograms/Diabetes/T2D/T4DM](https://clinical-risk-calculators.sydney.edu.au/Nomograms/Diabetes/T2D/T4DM)
:::

##  {background-image="snip22.png" background-size="small"}
...
- was it the testosterone treatment? Or the changes in body composition that led to the reduction in diabetes?
